...
//		$separator = ($isSef == 1) ? '?' : '&';
		...
		$backY = '<a class="backicY icagendabtn_'.$modid.'" href="'.$url.$separator.'iccaldate='.$backYYear.'-'.$month.'-'.$day.'" rel="nofollow"><span aria-hidden="true" class="iCicon iCicon-backicY"></span></a>';
		$back = '<a class="backic icagendabtn_'.$modid.'" href="'.$url.$separator.'iccaldate='.$backYear.'-'.$backMonth.'-'.$day.'" rel="nofollow"><span aria-hidden="true" class="iCicon iCicon-backic"></span></a>';

		$next = '<a class="nextic icagendabtn_'.$modid.'" href="'.$url.$separator.'iccaldate='.$nextYear.'-'.$nextMonth.'-'.$day.'" rel="nofollow"><span aria-hidden="true" class="iCicon iCicon-nextic"></span></a>';
		$nextY = '<a class="nexticY icagendabtn_'.$modid.'" href="'.$url.$separator.'iccaldate='.$nextYYear.'-'.$month.'-'.$day.'" rel="nofollow"><span aria-hidden="true" class="iCicon iCicon-nexticY"></span></a>';
