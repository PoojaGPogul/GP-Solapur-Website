...
//		$counter_input.= ' tabindex="999" maxlength="' . $ic_size . '" size="' . $ic_size . '"';
		...
		$html.= '<textarea onKeyPress="iCtextCounter(this, this.form.counter_' . $name.', '
									. $ic_max . ');" onKeyUp="iCtextCounter(this, this.form.counter_' . $name . ', '
									. $ic_max . ');"' . $class . ' name="' . $this->name . '">';
