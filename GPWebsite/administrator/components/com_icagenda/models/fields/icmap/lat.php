...
class JFormFieldiCmap_lat extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html.= '<label class="icmap-label">' . JText::_('COM_ICAGENDA_GOOGLE_MAPS_LATITUDE_LBL') . '</label> <input name="' . $this->name . '" id="lat" type="text" size="41" style="color:#777777;" value="' . $lat_value . '"/>';
