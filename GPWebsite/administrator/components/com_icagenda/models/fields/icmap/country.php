...
class JFormFieldiCmap_country extends JFormField
{
	...
	protected function getInput()
	{
		...
		$html.= '<label class="icmap-label">' . JText::_('COM_ICAGENDA_FORM_LBL_EVENT_COUNTRY') . '</label> <input name="' . $this->name . '" id="country" type="text" size="41" style="color:#777777;" value="' . $country_value . '" />';
