...
<!-- Image Joomla -->
					<td class="small hidden-phone">
						...
						if (($item->image) AND ($thumb_generator == 1))
						{
							...
							$l_crop = $l_thumbOptions[3] ? $l_thumbOptions[3] : false;
							...
							$m_crop = $m_thumbOptions[3] ? $m_thumbOptions[3] : false;
							...
							$s_crop = $s_thumbOptions[3] ? $s_thumbOptions[3] : false;

							// XSmall Size Options
							$xs_thumbOptions = $iCparams->get('thumb_xsmall');
							$xs_width = is_numeric($xs_thumbOptions[0]) ? $xs_thumbOptions[0] : '36';
							$xs_height = is_numeric($xs_thumbOptions[1]) ? $xs_thumbOptions[1] : '36';
							$xs_quality = is_numeric($xs_thumbOptions[2]) ? $xs_thumbOptions[2] : '80';
							$xs_crop = $xs_thumbOptions[3] ? $xs_thumbOptions[3] : true;

							// Generate large thumb if not exist
							iCThumbGet::thumbnail($item->image, $thumbsPath, 'themes', $l_width, $l_height, $l_quality, $l_crop, 'ic_large');
