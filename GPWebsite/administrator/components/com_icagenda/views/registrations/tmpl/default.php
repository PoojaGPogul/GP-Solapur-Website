			...
			<fieldset id="filter-bar">
				...
				<div class="filter-select fltrt">
					...
					<select name="filter_events" class="inputbox" onchange="this.form.submit()">
						<option value=""><?php echo JText::_('COM_ICAGENDA_SELECT_EVENT');?></option>
						...
						<td class="nowrap has-context">
							...
							<div class="pull-left" style="width:45%">
								...
								<?php if ($data_username) : ?>
									...
									<?php if ($data_name) echo '<strong>'.$this->escape($data_username).'</strong> <small>['.$this->escape($data_name).']</small>'; ?>
									<?php endif; ?>
							...
							<div class="pull-left">
								...
								<div class="small iC-italic-grey">
									<?php
									if ($item->period == 1) {
										echo JText::_('ICDATES') . ': <strong>' . JText::_( 'COM_ICAGENDA_REGISTRATION_ALL_DATES' ) . '</strong>';
									} else {
										echo JText::_('ICDATE') . ': <strong>' . $item->date . '</strong>';
									} ?>
								</div>
