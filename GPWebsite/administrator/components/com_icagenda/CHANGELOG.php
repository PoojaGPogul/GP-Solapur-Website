...
================================================================================
? <center><strong><big>Welcome to iCagenda 3.4.1 release!</big></strong></center><br />In this version, all the process to generate the main list of events was refactored, and many other functions were improved.<br />All reported minor bugs of previous versions are fixed. A medium priority issue with multi-language site is fixed.<br /><br /><center><strong><big>Enjoy!</big></strong></center>
================================================================================
...
~ Changed : You can now enter date before 1970/1/1 and after 2038/1/4 (no more unix limitation due to mktime php function, removed from date functions).
