...
class icagendaForm
{
	...
	static public function submit($parent_form = null)
	{
		...
		if ($parent_form == 1 && $app->isSite())
		{
			$ic_script[] = '		var reg_name = document.getElementById("' . $prefix_id . 'reg_name");';

			$ic_script[] = '		if ( ( reg_name.value == "" )';
			...
			$ic_script[] = '			document.getElementById("system-message").innerHTML = "<div class=\"alert alert-error\">'
											. JText::sprintf("COM_ICAGENDA_FORM_VALIDATE_FIELD_REQUIRED_NAME", JText::_("ICAGENDA_REGISTRATION_FORM_NAME")) . '</div>";';
//			$ic_script[] = '			document.getElementById("form_errors").style.display = "block";';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_name-lbl").addClass("ic-field-invalid-lbl");';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_name").addClass("ic-field-invalid-input");';
			$ic_script[] = '			scroll_to = document.getElementById("reg_name");';
			$ic_script[] = '			scroll_to.scrollIntoView();';
			$ic_script[] = '			return false;';
			$ic_script[] = '		}';
			$ic_script[] = '		else {';
//			$ic_script[] = '			document.getElementById("form_errors").style.display = "none";';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_name-lbl").removeClass("ic-field-invalid");';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_name").removeClass("ic-field-invalid");';
			$ic_script[] = '		}';
		}

		$email_required = JComponentHelper::getParams('com_icagenda')->get('emailRequired', '0');
		if ($parent_form == 1 && $email_required == 1 && $app->isSite())
		{
			$ic_script[] = '		var reg_email = document.getElementById("' . $prefix_id . 'reg_email");';

			$ic_script[] = '		if ( ( reg_email.value == "" )';
			...
			$ic_script[] = '			alert(Joomla.JText._("COM_ICAGENDA_FORM_NC"));';
			$ic_script[] = '			document.getElementById("system-message").innerHTML = "<div class=\"alert alert-error\">'
											. JText::sprintf("COM_ICAGENDA_FORM_VALIDATE_FIELD_REQUIRED_NAME", JText::_("ICAGENDA_REGISTRATION_FORM_EMAIL")) . '</div>";';
//			$ic_script[] = '			document.getElementById("form_errors").style.display = "block";';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_email-lbl").addClass("ic-field-invalid-lbl");';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_email").addClass("ic-field-invalid-input");';
			$ic_script[] = '			scroll_to = document.getElementById("reg_email");';
			$ic_script[] = '			scroll_to.scrollIntoView();';
			$ic_script[] = '			return false;';
			$ic_script[] = '		}';
			$ic_script[] = '		else {';
//			$ic_script[] = '			document.getElementById("form_errors").style.display = "none";';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_email-lbl").removeClass("ic-field-invalid");';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_email").removeClass("ic-field-invalid");';
			$ic_script[] = '		}';
		}

		$phone_required = JComponentHelper::getParams('com_icagenda')->get('phoneRequired', '0');
		if ($parent_form == 1 && $phone_required == 1 && $app->isSite())
		{
			$ic_script[] = '		var reg_phone = document.getElementById("' . $prefix_id . 'reg_phone");';

			$ic_script[] = '		if ( ( reg_phone.value == "" )';
			...
			$ic_script[] = '			alert(Joomla.JText._("COM_ICAGENDA_FORM_NC"));';
			$ic_script[] = '			document.getElementById("system-message").innerHTML = "<div class=\"alert alert-error\">'
											. JText::sprintf("COM_ICAGENDA_FORM_VALIDATE_FIELD_REQUIRED_NAME", JText::_("ICAGENDA_REGISTRATION_FORM_PHONE")) . '</div>";';
//			$ic_script[] = '			document.getElementById("form_errors").style.display = "block";';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_phone-lbl").addClass("ic-field-invalid-lbl");';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_phone").addClass("ic-field-invalid-input");';
			$ic_script[] = '			scroll_to = document.getElementById("reg_phone");';
			$ic_script[] = '			scroll_to.scrollIntoView();';
			$ic_script[] = '			return false;';
			$ic_script[] = '		}';
			$ic_script[] = '		else {';
//			$ic_script[] = '			document.getElementById("form_errors").style.display = "none";';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_phone-lbl").removeClass("ic-field-invalid");';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'reg_phone").removeClass("ic-field-invalid");';
			$ic_script[] = '		}';
		}
		...
		if ($parent_form == 2)
		{
			...
			$ic_script[] = '		var title = document.getElementById("' . $prefix_id . 'title");';

			$ic_script[] = '		if ( ( title.value == "" )';
			...
			$ic_script[] = '			document.getElementById("message_error").innerHTML = "'
											. JText::sprintf("COM_ICAGENDA_FORM_VALIDATE_FIELD_REQUIRED_NAME", JText::_("JGLOBAL_TITLE")) . '";';
			$ic_script[] = '			document.getElementById("form_errors").style.display = "block";';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'title-lbl").addClass("ic-field-invalid-lbl");';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'title").addClass("ic-field-invalid-input");';
			$ic_script[] = '			scroll_to = document.getElementById("ic-event-fieldset");';
			$ic_script[] = '			scroll_to.scrollIntoView();';
			$ic_script[] = '			return false;';
			$ic_script[] = '		}';
			$ic_script[] = '		else {';
			$ic_script[] = '			document.getElementById("form_errors").style.display = "none";';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'title-lbl").removeClass("ic-field-invalid");';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'title").removeClass("ic-field-invalid");';
			$ic_script[] = '		}';

			$ic_script[] = '		var category = document.getElementById("' . $prefix_id . 'catid");';

			$ic_script[] = '		if ( ( category.value == "" )';
			...
			$ic_script[] = '			alert(Joomla.JText._("COM_ICAGENDA_FORM_NC"));';
			$ic_script[] = '			document.getElementById("message_error").innerHTML = "'
											. JText::sprintf("COM_ICAGENDA_FORM_VALIDATE_FIELD_REQUIRED_NAME", JText::_("COM_ICAGENDA_FORM_LBL_EVENT_CATID")) . '";';
			$ic_script[] = '			document.getElementById("form_errors").style.display = "block";';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'catid-lbl").addClass("ic-field-invalid-lbl");';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'catid").addClass("ic-field-invalid-input");';
			$ic_script[] = '			scroll_to = document.getElementById("ic-event-fieldset");';
			$ic_script[] = '			scroll_to.scrollIntoView();';
			$ic_script[] = '			return false;';
			$ic_script[] = '		}';
			$ic_script[] = '		else {';
			$ic_script[] = '			document.getElementById("form_errors").style.display = "none";';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'catid-lbl").removeClass("ic-field-invalid");';
			$ic_script[] = '			document.getElementById("' . $prefix_id . 'catid").removeClass("ic-field-invalid");';
			$ic_script[] = '		}';
		...
		if ($customfields)
		{
			foreach ($customfields as $icf)
			{
				if ($icf->required)
				{
					...
					$ic_script[] = '		) {';
//					$ic_script[] = '			'.$icf->slug.'.setAttribute("aria-invalid", "true");';
					$ic_script[] = '			alert(Joomla.JText._("COM_ICAGENDA_FORM_NC"));';
					$ic_script[] = '			document.getElementById("message_error").innerHTML = "'
