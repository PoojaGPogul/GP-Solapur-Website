	...
	<div class="icevent <?php echo $multi_events; ?>" style="background:<?php echo $bg_day; ?> !important; z-index:1000;">
		...
		<span class="spanEv">
			...
			<?php foreach($events as $e){
				...
				// Show image if exist
				if ($e['image']) {
					echo '<a href="'.$e['url'].'" rel="nofollow"><div class="linkTo"><span style="background: '.$e['cat_color'].';" class="img"><img src="'.$e['image'].'" alt="" /></span>';
				}
				else {
					echo '<a href="'.$e['url'].'" rel="nofollow"><div class="linkTo"><span style="background: '.$e['cat_color'].';" class="img"><div class="noimg '.$bgcolor.'">'.$e['no_image'].'</div></span>';
				}

				// Display Title (with link to event) and other infos if set (city, country)
				echo '<span><div class="icmodcal-tip-title titletip">&rsaquo; '.$e['title'].'</div>';
				...
				if (($e['maxTickets']) || ($e['registered'])) {
					echo '<div class="regButtons ic-reg-buttons">';
					if ($e['maxTickets']) {
